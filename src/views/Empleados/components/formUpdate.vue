...
const submitForm = (formEl: FormInstance | undefined) => {
  ...
  formEl.validate((valid) => {
    if (valid) {
      ...
      formData.append('password', ruleForm.pass.toString())
      ...
      axios.patch(`http://127.0.0.1:8000/api/empleado/1`, formData, {
        headers: {
      ...
      .then(function (response) {
        ...
        ElMessage({
          showClose: true,
          message: `Colaborador ${props.user.id} actualizado correctamente`,
          type:'success'
        })    
      })
